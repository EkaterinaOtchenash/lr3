...
namespace WindowsFormsApp1.UserClasses
{
    public abstract class InfoEmail
	{
		...
		public string SmtpClientAdress
		{
			...
			set
			{
				_smtpClientAdress = String.IsNullOrWhiteSpace(value) ? throw new ArgumentNullException(nameof(_smtpClientAdress)) : value;
			}
		}
		...
		public string EmailPassword
		{
			...
			set
			{
				_emailPassword = String.IsNullOrWhiteSpace(value) ? throw new ArgumentNullException(nameof(_emailPassword)) : value; 
			}
		}
